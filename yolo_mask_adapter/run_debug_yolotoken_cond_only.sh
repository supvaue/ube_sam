...
/root/anaconda3/bin/python -u yolo_mask_adapter/eval_dense_tracking_protocol.py \
  ...
  --device cuda:0 \
  --debug \
  --output-json yolo_mask_adapter/results/debug_yolotoken_forced_cond_cond_only_ligament_5gt.json \
  2>&1 | tee yolo_mask_adapter/results/logs/debug_yolotoken_forced_cond_cond_only_ligament_5gt.log
