...
OUT_DIR=yolo_mask_adapter/results/shared_decoder_tracking_ligament_smoke_e3
...
echo "[stage] start shared-decoder tracking smoke training"
...
/root/anaconda3/bin/python -u yolo_mask_adapter/train_shared_decoder_tracking.py \
  ...
  2>&1 | tee yolo_mask_adapter/results/logs/train_shared_decoder_tracking_ligament_smoke_e3.log
