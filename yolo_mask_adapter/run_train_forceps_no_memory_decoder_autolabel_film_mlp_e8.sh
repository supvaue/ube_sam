...
OUT_DIR=yolo_mask_adapter/results/forceps_no_memory_decoder_autolabel_film_mlp_nomemattn_reinit_e8
LOG_PATH=yolo_mask_adapter/results/logs/train_forceps_no_memory_decoder_autolabel_film_mlp_nomemattn_reinit_e8.log
...
echo "[stage] train forceps no-memory-decoder with film_mlp condition fusion"
