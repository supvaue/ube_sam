...
OUT_DIR=yolo_mask_adapter/results/forceps_shared_decoder_autolabel_film_mlp_memonly_e4
LOG_PATH=yolo_mask_adapter/results/logs/train_forceps_shared_decoder_autolabel_film_mlp_memonly_e4.log
...
echo "[stage] train forceps shared decoder with pure memory tracking branch"
echo "[stage] memory branch uses tracking-prompt-source=none"
