...
def rvos_inference(
    ...
    for out_frame_idx, out_obj_ids, out_mask_logits in predictor.propagate_in_video(
        ...
        # Move frame logits to CPU immediately to avoid accumulating GPU memory across all frames.
        obj_scores = out_mask_logits.detach().cpu()
...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="offload decoded video frames to CPU memory to reduce GPU usage",
    )
    parser.add_argument(
        "--offload_state_to_cpu",
        action="store_true",
        help="offload inference state tensors to CPU memory to reduce GPU usage",
    )
    # ----
    parser.add_argument(
